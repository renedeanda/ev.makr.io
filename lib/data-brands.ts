...
export const brands: Brand[] = [
  ...
  },
  {
    ...
    modelCount: 3,
    description: "Award-winning IONIQ lineup with 800V architecture. IONIQ 5, IONIQ 6, and new IONIQ 9 3-row SUV. Native NACS on 2025+.",
    featured: true,
  },
  {
    name: "Kia",
    ...
    modelCount: 4,
    description: "Comprehensive EV lineup: Niro EV, EV4, EV6 (2023 World Car of the Year), and EV9 3-row SUV. 800V fast charging, 10-year warranty.",
    featured: true,
  },
  {
    name: "Lexus",
    slug: "lexus",
    urlPath: "/vehicles?make=lexus",
    modelCount: 2,
    description: "Toyota's luxury brand enters EVs with UX 300e compact SUV and RZ crossover. Premium build quality with advanced safety features.",
  },
  {
    name: "Lucid",
    slug: "lucid",
  ...
  },
  {
    name: "Volvo",
    slug: "volvo",
    urlPath: "/vehicles?make=volvo",
    modelCount: 5,
    description: "Swedish luxury brand with comprehensive EV lineup: XC40, C40/EC40, EX30, and EX90. Android Automotive OS, Scandinavian design.",
  },
];
